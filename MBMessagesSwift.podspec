...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "LorenzOliveto"
  # s.authors            = { "LorenzOliveto" => "lorenzo.oliveto@mumbleideas.it" }
  # s.social_media_url   = "http://twitter.com/LorenzOliveto"
  ...
  s.source       = { git: 'https://github.com/Mumble-SRL/MBMessagesSwift.git', tag: '0.1.4' }
  s.source_files = "MBMessagesSwift/*.{h,m,swift}", "MBMessagesSwift/**/*.{h,m,swift}"
